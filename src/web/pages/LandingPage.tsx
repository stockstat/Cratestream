...
export function LandingPage() {
  ...
  // REPLACE THIS WITH YOUR ACTUAL GITHUB RELEASE DOWNLOAD URL
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center p-4">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-400 text-sm mt-4 font-medium">
            Free 7-day trial • Windows 10/11 • ~150MB
          </p>
        ...
        <div className="bg-black/40 backdrop-blur-sm rounded-xl p-6 border border-orange-500/20 max-w-2xl mb-8">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm text-gray-300">
            <div>
              <span className="text-white font-bold">OS:</span> Windows 10/11
            </div>
            <div>
              <span className="text-white font-bold">RAM:</span> 4GB minimum
            </div>
            <div>
              <span className="text-white font-bold">Storage:</span> 200MB free
            </div>
            <div>
              <span className="text-white font-bold">Internet:</span> Required
            </div>
          </div>
        </div>
